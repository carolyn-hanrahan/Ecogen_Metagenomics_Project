setwd("C:/Users/Carolyn/Desktop/Ecogen Group Project/Ecogen_Metagenomics_Project/16S_data") 
...
bacteria <- read_excel("16Sdata.xlsx")
otu_mat<- read_excel("16Sdata.xlsx", sheet = "OTU matrix")
tax_mat<- read_excel("16Sdata.xlsx", sheet = "Taxonomy table")
samples_df <- read_excel("16Sdata.xlsx", sheet = "Samples")
