setwd("/Users/alexanderkissonergis/Documents/GitHub/ecologicalGenomics/GroupProject/HempTomato16SITS/ITS/")
...
#Rawdata
data <- read.xlsx("ITS_Sequence_Data_clean.xlsx", sheet = 1, colNames = TRUE, rowNames = TRUE)
...
otu_mat<- as.data.frame(read_excel("ITS_Sequence_Data_clean.xlsx", sheet = "OTU matrix"))
tax_mat<- read_excel("ITS_Sequence_Data_clean.xlsx", sheet = "Taxonomy table")
samples_df <- as.data.frame(read_excel("ITS_Sequence_Data_clean.xlsx", sheet = "Samples"))
...
countTable <- tax_table(physeq.prune)
